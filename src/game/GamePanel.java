...
public class GamePanel extends JPanel implements ActionListener {
    ...
    static final int SCREEN_WIDTH=1300;//tamaño anchura ventana
    static final int SCREEN_HEIGHT=750;//tamaño altura ventana
    static final int UNIT_SIZE=50;//tamaño objetos
